...
var FigureManager = /** @class */ (function () {
    function FigureManager(_a) {
        ...
        this.Figure = function (_a) {
            var caption = _a.caption, label = _a.label, props = __rest(_a, ["caption", "label"]);
            var figure = _this._figures[label];
            return Figure(__assign({ src: figure.src, caption: React.createElement("span", null,
                    React.createElement("strong", null,
                        _this._prefix + ' ' + figure.num,
                        ":"),
                    " ",
                    caption), label: label }, props));
        };
