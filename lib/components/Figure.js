...
export function Figure(_a) {
    var src = _a.src, caption = _a.caption, label = _a.label, style = _a.style, figureStyle = _a.figureStyle, className = _a.className, alt = _a.alt, align = _a.align, width = _a.width, maxWidth = _a.maxWidth, autoPlay = _a.autoPlay, loop = _a.loop;
    ...
    return React.createElement("div", { className: 'figure ' + (className !== null && className !== void 0 ? className : ""), style: __assign({ position: "relative", textAlign: (align !== null && align !== void 0 ? align : "center") }, style) },
        React.createElement("figure", { id: label, style: __assign({ width: width, maxWidth: maxWidth, display: "inline-block" }, figureStyle) },
            ...
            isVideo && React.createElement("video", { className: "figure-video", src: src, autoPlay: autoPlay, loop: loop }, "Your browser does not support the video tag."),
